...
public class AI_Assistant extends HttpServlet {
    ...
    private String sendPostRequest(String userMessage) {
        ...
        return response.toString().replace("Mohammed:", "");
    }
