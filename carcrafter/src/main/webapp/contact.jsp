                    ...
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                ...
                                <p>Rue Al Houria Hay Al Hikma, Oujda, Morocco</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                <h5>Call Us</h5>
                                <p><a href="tel:+212 500-000000">+212 500-000000</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                <h5>Email Us</h5>
                                <p><a href="mailto:carcrafter@support.com">carcrafter@support.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
