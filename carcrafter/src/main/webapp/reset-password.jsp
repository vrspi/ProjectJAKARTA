...
<head>
    ...
    <!-- title -->
    <title>Car Crafter - Reset Password</title>
            ...
            <div class="login-form">
                ...
                <form action="UserController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Your Current Password" name="oldPassword" required>
                    </div>
                    <div class="form-group">
                        <label>New Password</label>
                        <input type="password" class="form-control" placeholder="Your New Password" name="newPassword" required>
                    </div>
                    <div class="form-group">
                        <label>Confirm New Password</label>
                        <input type="password" class="form-control" placeholder="Confirm Your New Password" name="confirmPassword" required>
                    </div>
                    <div class="d-flex align-items-center">
                        <button type="submit" class="theme-btn" name="action" value="changePassword"><i class="fas fa-sync-alt"></i> Change Password</button>
                    </div>
                </form>
